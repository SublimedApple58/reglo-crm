...
-- Insert new stages
INSERT INTO pipeline_stages (id, label, color, tone, "order") VALUES ('in_attesa', 'In attesa', '#7C3AED', 'violet', 4) ON CONFLICT (id) DO NOTHING;
INSERT INTO pipeline_stages (id, label, color, tone, "order") VALUES ('non_chiuso', 'Non chiuso', '#DC2626', 'red', 8) ON CONFLICT (id) DO NOTHING;
